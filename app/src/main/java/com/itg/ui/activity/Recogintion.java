/**
* @FileName Recogintion.java
* @Package com.itg.ui.activity
* @Description TODO
* @Author Alpha
* @Date 2015-8-20 下午3:30:13 
* @Version V1.0
...
public class Recogintion extends Activity implements OnClickListener {
	  ...
	  private static final int VOICE_RECOGNITION_REQUEST_CODE = 1234;     
	    ...
	    {     
	        ...
	        setContentView(R.layout.iguide_voice_recoginise);     
