...
public class ContactsSectionIndexer implements SectionIndexer
{
	...
	public ContactsSectionIndexer(List<City> contacts)
	{
	...
	public void initPositions(List<City> contacts)
	{
		...
		for (City contact : contacts)
		{

			String indexableItem = contact.getCIndex();
