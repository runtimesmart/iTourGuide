/**
* @FileName NumberCircleBar.java
* @Package com.itg.ui.view
* @Description TODO
* @Author Alpha
* @Date 2015-9-15 下午4:24:14 
* @Version V1.0
...
public class NumberCircleBar extends View {
	...
	public NumberCircleBar(Context context) {
		this(context, null);
	}

	public NumberCircleBar(Context context, AttributeSet attrs) {
