#include <com_itg_jni_ImageBlur.h>
#include <ImageBlur.c>
#include <android/log.h>
#include <android/bitmap.h>


JNIEXPORT void JNICALL Java_com_itg_jni_ImageBlur_blurIntArray
...
JNIEXPORT void JNICALL Java_com_itg_jni_ImageBlur_blurBitMap
